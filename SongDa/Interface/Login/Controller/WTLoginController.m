...
- (void)setupLoginView {
    ...
    // logo
    UIImageView *logoImgView = [[UIImageView alloc] initWithImage:HYXImage(@"login_logo")];
...
#warning hyx_changeCopyrightName
    ...
    copyrightLabel.text = @"版权所有©长春市朝阳区人民法院";
...
//    phoneTextField.text = @"15080338683";
//    phoneTextField.text = @"13646023208";
...
//    NSDictionary *paras = @{@"mobile" : self.phoneTextField.text, @"verifyCode" : self.pwdTextField.text};
    NSDictionary *paras = @{@"mobile" : self.phoneTextField.text, @"pwd" : [self.pwdTextField.text base64EncodedString]};
